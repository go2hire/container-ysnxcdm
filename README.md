...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ysnxcdm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ysnxcdm.containers.anotherwebservice.com/
...
```
git clone git@github.com:go2hire/container-ysnxcdm.git
cd container-ysnxcdm
```
...
```
docker attach container-ysnxcdm
```
